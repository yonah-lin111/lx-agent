...
export const GRILL_ME_SKILL_PROMPT = [
  ...
  "    Every question turn MUST wrap exactly ONE grill-question block in `<grill_question>` and `</grill_question>` tags, with the three labeled lines inside and nothing else in the block:",
  "",
  "    <grill_question>",
