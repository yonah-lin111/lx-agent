    ...
    text: (ctx) => {
      if (ctx.collaborationMode === "plan") {
        return [
          ...
          "",
          "## Structured 3-Phase Plan Workflow",
          "1. Phase 1 - Exploration & Grounding: Explore the workspace, inspect symbols, map dependencies, and understand relevant existing conventions without making assumptions.",
          "2. Phase 2 - Clarification & Preferences: Identify hidden trade-offs or ambiguous requirements; actively use the question tool or chat to clarify decisions with the user.",
          "3. Phase 3 - Specification & Transition: Output the complete `<proposed_plan>` outlining concrete steps, modified files, and verification commands.",
          "",
