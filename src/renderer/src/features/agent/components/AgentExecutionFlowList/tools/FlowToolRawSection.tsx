...
/**
 * 工具原始数据折叠区（输入参数 + 执行结果，样式对齐 FlowToolTodo）：
...
export const FlowToolRawSection = ({
  ...
  return (
    <div className="agent-execution-flow-tool-raw-section border-t border-[var(--color-theme-border,rgba(255,255,255,0.06))] pt-1 font-mono text-xs">
      <button
        type="button"
      ...
      {isOpen && (
        <div id={contentId} className="mt-2 flex flex-col gap-2">
          <div>
