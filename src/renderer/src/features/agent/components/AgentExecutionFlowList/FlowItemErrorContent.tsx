...
export const FlowItemErrorContent = ({
  ...
  return (
    <div className="agent-execution-flow-error-content flex flex-col gap-2">
      <div
        className={`custom-scrollbar max-h-60 overflow-y-auto rounded p-2 font-mono text-xs leading-relaxed ${
          content.isAborted
      ...
      {content.stopReason && (
        <div className="flex items-center gap-2 border-t border-white/5 pt-1.5 font-mono text-xs text-white/40">
          <span>
