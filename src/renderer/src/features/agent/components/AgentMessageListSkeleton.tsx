...
export const AgentMessageListSkeleton = ({
  ...
  return (
    <div
      aria-hidden="true"
      className={`pointer-events-auto absolute inset-0 z-20 select-none overflow-hidden bg-[#212121] p-1 ${
    ...
    >
      <div className="flex flex-col gap-5">
        ...
        <div className="flex justify-end">
          <SkeletonBlock className="flex w-[52%] flex-col gap-1.5 p-3">
            <div className="h-3 w-3/4 rounded-[4px] bg-white/[0.14]" />
            <div className="h-3 w-1/2 rounded-[4px] bg-white/[0.14]" />
          </SkeletonBlock>
        </div>
        ...
        <SkeletonBlock className="h-3.5 w-[84%]" />

        {/* 代码块 */}
        <SkeletonBlock className="flex h-16 flex-col gap-1.5 p-2.5">
          <div className="h-3 w-1/3 rounded-[4px] bg-white/[0.14]" />
          <div className="h-3 w-4/5 rounded-[4px] bg-white/[0.08]" />
          <div className="h-3 w-3/5 rounded-[4px] bg-white/[0.08]" />
        </SkeletonBlock>

        {/* 第二轮用户问题气泡 */}
        <div className="flex justify-end">
          <SkeletonBlock className="flex w-[40%] flex-col gap-1.5 p-3">
            <div className="h-3 w-2/3 rounded-[4px] bg-white/[0.14]" />
          </SkeletonBlock>
        </div>
