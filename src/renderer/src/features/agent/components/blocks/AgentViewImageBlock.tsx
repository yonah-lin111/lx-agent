...
/**
 * view_image 结果块：缩略图预览 + 文件名/尺寸/精度元信息。
 */
export const AgentViewImageBlock = ({ details }: AgentViewImageBlockProps): React.JSX.Element => {
  ...
  return (
    <div className="agent-view-image-block my-0.5 flex min-w-0 flex-col gap-1.5">
      <div className="agent-view-image-header flex items-center gap-1.5 font-mono text-[12px] leading-none">
        <Eye className="h-3.5 w-3.5 shrink-0 text-amber-300" />
        <span className="shrink-0 font-bold text-amber-300">view_image</span>
