        ...
        <div className="flex flex-wrap items-center justify-end gap-1.5 min-w-0 max-w-full">
          {design.sessionId && (
            <LxIconButton
              ...
              className="front-design-dir-btn border border-white/10 py-1 text-xs max-w-full"
          ...
          <LxIconButton
            ...
            className="front-design-iterate-btn border border-pink-500/30 bg-pink-500/10 py-1 text-xs font-medium max-w-full"
          ...
          <LxIconButton
            ...
            className="front-design-open-btn bg-pink-600 py-1 text-xs font-medium max-w-full"
