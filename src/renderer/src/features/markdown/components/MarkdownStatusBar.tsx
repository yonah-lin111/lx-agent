...
export const MarkdownStatusBar = ({
  ...
  return (
    <div className="flex h-8 min-h-[32px] flex-none shrink-0 min-w-0 items-center justify-between gap-3 border-t border-white/5 px-1.5 py-1 text-xs text-white/50">
