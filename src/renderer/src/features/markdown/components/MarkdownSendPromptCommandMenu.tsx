...
const renderProductLogo = (targetType: string) => {
  switch (targetType) {
    case "claude":
      return (
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
          className="h-3.5 w-3.5 flex-none text-[#D97757]"
          aria-hidden="true"
        >
    ...
    case "opencode":
      return (
        <svg
          viewBox="0 0 16 16"
          fill="currentColor"
          className="h-3.5 w-3.5 flex-none text-white/90"
          aria-hidden="true"
        >
          <path
            fillRule="evenodd"
    ...
    case "codex":
      return (
        <svg
          ...
          fill="currentColor"
          fillRule="evenodd"
          className="h-3.5 w-3.5 flex-none text-[#10A37F]"
          aria-hidden="true"
        >
    ...
    case "gemini":
      return (
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
          className="h-3.5 w-3.5 flex-none text-[#4285F4]"
          aria-hidden="true"
        >
    ...
    case "agy":
      return (
        <svg
          viewBox="0 0 112 112"
          fill="currentColor"
          className="h-3.5 w-3.5 flex-none text-[#3186FF]"
          aria-hidden="true"
        >
