    ...
    <div className="flex min-w-0 flex-col gap-2">
      ...
      <div className="flex min-w-0 items-center justify-between gap-3">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <h2 className="truncate text-sm font-semibold text-white/90">{cardTitle}</h2>
        </div>
        ...
        <div className="grid min-w-0 grid-cols-2 gap-2 sm:grid-cols-4">
          ...
          <div className="overview-summary-item flex min-w-0 items-center gap-2 rounded-[4px] border border-[#333333] bg-[#282828] p-2">
            ...
            <div className="min-w-0 flex-1">
              <div className="truncate text-xs text-white/45">{t("home.summary.turns")}</div>
          ...
          <div className="overview-summary-item flex min-w-0 items-center gap-2 rounded-[4px] border border-[#333333] bg-[#282828] p-2">
            ...
            <div className="min-w-0 flex-1">
              <div className="truncate text-xs text-white/45">{t("home.summary.toolCalls")}</div>
              <div className="truncate text-sm font-semibold text-white/90">
          ...
          <div className="overview-summary-item flex min-w-0 items-center gap-2 rounded-[4px] border border-[#333333] bg-[#282828] p-2">
            ...
            <div className="min-w-0 flex-1">
              <div className="truncate text-xs text-white/45">{t("home.summary.successRate")}</div>
              <div className="truncate text-sm font-semibold text-emerald-400">{successRate}%</div>
            </div>
          </div>
          ...
          <div className="overview-summary-item flex min-w-0 items-center gap-2 rounded-[4px] border border-[#333333] bg-[#282828] p-2">
            ...
            <div className="min-w-0 flex-1">
              <div className="truncate text-xs text-white/45">{t("home.summary.avgDuration")}</div>
              <div className="truncate text-sm font-semibold text-white/90">
                {avgDuration}
                <span className="ml-0.5 text-xs font-normal text-white/45">ms</span>
              </div>
            </div>
          </div>
        </div>
