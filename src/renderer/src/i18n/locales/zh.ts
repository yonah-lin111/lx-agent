...
export const zh: TranslationDictionary = {
  ...
  openclaw: {
    ...
    abort: "中止",
    sessions: "会话",
    sessionPickerTitle: "选择会话",
    sessionNew: "新建对话",
    sessionNewHint: "为该员工开启新会话",
    sessionEmpty: "该员工还没有会话，可新建一条。",
    sessionLoading: "正在加载会话…",
    sessionUnbound: "该员工尚未绑定会话",
    sessionUnboundHint: "发送消息将自动新建会话；输入 /clear 可切换会话。",
    sessionNoAgent: "请先选择一位员工。",
    sessionLoadFailed: "会话列表加载失败",
    sessionCreateFailed: "新建会话失败",
    sessionBindFailed: "切换会话失败",
    statusConnected: "已连接",
    ...
    commandClearDesc: "选择或新建当前员工的会话",
    commandStopDesc: "中止所有运行中的任务",
    commandAgentDesc: "选择接收任务的员工",
