...
4. **Permission Mode**：无匹配时依据当前模式执行自动放行或弹窗询问。`,
  ...
  markdown: {
    ...
    unfoldPreset: "展开预设模板",
    deletePreset: "删除预设模板",
    confirmDeletePreset: "确定删除该预设模板块？",
