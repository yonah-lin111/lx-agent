...
4. **Permission Mode**: Evaluates default fallback behavior.`,
  ...
  markdown: {
    ...
    sendPromptFlagNewDesc: "Launch in a new terminal tab with prompt",
    sendPromptFlagNewTag: "New",
    ...
    sendPromptTargetClaudeDesc: "Send to Terminal Claude Code CLI",
    sendPromptTargetOpencodeDesc: "Send to Terminal OpenCode CLI",
    sendPromptTargetCodexDesc: "Send to Terminal Codex CLI",
    sendPromptTargetAgyDesc: "Send to Terminal Antigravity (agy) CLI",
