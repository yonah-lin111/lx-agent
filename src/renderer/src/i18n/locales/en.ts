export const en = {
  ...
  openclaw: {
    ...
    sessionNewHint: "Start a new session for this coworker",
    sessionEmpty: "No session yet for this coworker. Create one.",
    sessionLoading: "Loading sessions…",
    sessionUnbound: "No session bound to this coworker",
    sessionUnboundHint:
      "Sending a message will create a new session; type /clear to switch sessions.",
    sessionNoAgent: "Select a coworker first.",
    sessionLoadFailed: "Failed to load sessions",
    sessionCreateFailed: "Failed to create session",
    sessionBindFailed: "Failed to switch session",
    ...
    commandClearDesc: "Pick or create a session for this coworker",
    commandStopDesc: "Stop all running tasks",
    commandAgentDesc: "Choose coworkers to receive the task",
