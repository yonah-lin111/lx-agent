export const en = {
  ...
  openclaw: {
    ...
    officeEmpty: "This office has no coworker yet. Fetch agents in Settings → OpenClaw.",
    officeHint: "Click a coworker to select the target; Ctrl/Cmd-click to multi-select.",
    ...
    commandModeDesc: "Toggle conversation / workspace mode",
  },
  settings: {
    title: "Settings",
    general: "General",
