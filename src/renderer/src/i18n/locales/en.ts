export const en = {
  ...
  agent: {
    ...
    closeExecutionFlow: "Close Execution Flow",
    ...
    autoStickToBottom: "Auto scroll to bottom",
    autoStickToBottomOn: "Auto scroll to bottom (Enabled)",
    autoStickToBottomOff: "Auto scroll to bottom (Disabled)",
    filterAll: "All",
    filterSystem: "System",
