export const openclaw = {
  ...
  conversationFilteredEmpty:
    "No messages under the current filter. Use the restore button above to show all.",
  onlyFilterLabel: "Only:",
  onlyPickerTitle: "Select coworkers to show",
  onlyFilterClear: "Show all messages",
  onlyFilterRemove: "Remove from filter",
  ...
  attachmentFileTooLarge: "A single file cannot exceed {{size}}",
