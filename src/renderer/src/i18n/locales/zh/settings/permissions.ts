...
- **生效时机**：下一轮对话生效；硬基线工具在保存时自动从白名单中剥离。`,
  ...
  customCommandAgentInputTab: "对话命令",
  customCommandAgentMDTab: "模板命令",
  ...
  customCommandBlockGroupTemplate: "文档模板块",
  customCommandBlockTemplateBasic: "基础块",
  customCommandBlockTemplateTitled: "带标题块",
  customCommandBlockGroupSupple: "补充块",
  customCommandBlockSupple: "补充需求块",
  customCommandBlockGroupLog: "日志块",
  customCommandBlockLog: "执行日志块",
  ...
  customCommandAgentMDHelpTitle: "Markdown 模板命令使用说明",
