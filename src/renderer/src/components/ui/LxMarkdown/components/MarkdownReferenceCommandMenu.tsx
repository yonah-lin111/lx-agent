...
export const MarkdownReferenceCommandMenu = ({
  ...
  <div
    aria-label="引用类型"
    className="markdown-command-menu markdown-command-menu--reference pointer-events-none fixed z-50 overflow-hidden rounded-[6px] border border-white/10 bg-[#303030] p-1 text-[13px] shadow-[0_10px_28px_rgba(0,0,0,0.45)]"
    role="listbox"
    style={position}
  >
