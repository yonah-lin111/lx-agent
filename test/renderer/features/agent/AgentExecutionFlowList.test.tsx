...
describe("AgentExecutionFlowList", () => {
  ...
  it("支持筛选功能", () => {
    ...
    // 切换到工具筛选
    const toolFilterBtn = screen.getByRole("button", { name: /Tool \(1\)/ })
  ...
  it("在具有 Token 数据的 Item 和 Group 底部展示 IN / OUT / CACHE 指标栏，且无 Token 步骤不展示", () => {
    ...
    expect(toolFooter?.textContent).toContain("Batch Total")
