...
- [x] **Task 11.1: HeadTailBuffer 对称式截断缓冲实现**
...
- [x] **Task 11.2: UnifiedExecManager 统一生命周期与进程调度管理**
...
- [x] **Task 12.1: ApprovalPolicy 契约扩展**
...
- [x] **Task 12.2: PermissionManager 审批升级与会话白名单机制**
