...
```text
# 素材位置（绝对路径，view_image 直接支持；注意 `~` 不会被展开）：
# /Users/yonah/Desktop/view-image-fixtures/
...
- **提示词**：`查看 /Users/yonah/Desktop/view-image-fixtures/small-shot.png，描述画面内容`
...
- **提示词**：`查看 /Users/yonah/Desktop/view-image-fixtures/big-4000.png`
...
- **提示词**：`用 view_image 的 original 精度查看 /Users/yonah/Desktop/view-image-fixtures/text-shot.png，逐字读出图中文字`
...
- **提示词**：`查看 /Users/yonah/Desktop/view-image-fixtures/heavy-noise.png`
- **验证步骤**：观察元信息与结果摘要。
...
- **提示词**：依次发送 `查看 /Users/yonah/Desktop/view-image-fixtures/missing.png`、`查看 /Users/yonah/Desktop/view-image-fixtures/`、`查看 /Users/yonah/Desktop/view-image-fixtures/icon.svg`、`查看 /Users/yonah/Desktop/view-image-fixtures/unsupported.gif`、`查看 /Users/yonah/Desktop/view-image-fixtures/huge.png`
...
- **提示词**：`查看 /Users/yonah/Desktop/view-image-fixtures/small-shot.png`
...
- **提示词**：`同时查看 /Users/yonah/Desktop/view-image-fixtures/small-shot.png 和 /Users/yonah/Desktop/view-image-fixtures/big-4000.png，对比差异`
...
- **提示词**：先完成组 1，再连续进行 3 轮以上与图片无关的问答，最后发送：`刚才那张 /Users/yonah/Desktop/view-image-fixtures/small-shot.png 里有什么？`
